...
<html>
    ...
    <body>
            ...
            <form method="post" >
                <table>
                    ...
                    <trs>
                        ...
                        <tbody>
                            <tr>
                                <td colspan="3">Renal Function Test</td>
                            </tr>
                            <tr>
                                <td>Urea</td>
                                <td>
                            ...
                            <tr style="text-align: center" >
                                <td colspan="3">Report authorized by: <input type="text" name="result3"></td> 
                            </tr>
                            <tr>
        ...
        <%
           ...
           PreparedStatement pst = con.prepareStatement("INSERT INTO renal (PatientName, Age, Urea ,Creatinine, Doctor) VALUES (?,?,?,?,?)");
